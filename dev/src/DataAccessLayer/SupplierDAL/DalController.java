...
public abstract class DalController {
    ...
    protected abstract void cleanCacheForTests();
    // update table row when value is string
    public boolean update(int id, String attributeName, String attributeValue, String columnName) {
    ...
    public boolean update(int value1, int value2, String attributeName, Double attributeValue, String columnName1, String columnName2) {
        String sql = "UPDATE "+tableName+" SET "+attributeName+" = ? "
    ...
    public boolean update(int id1, int id2, String attributeName, int attributeValue, String column1, String column2) {
        String sql = "UPDATE "+tableName+" SET "+attributeName+" = ? "
    ...
    public Object select(String id1, int id2, int id3, String columnName1, String columnName2, String columnName3)
    {
